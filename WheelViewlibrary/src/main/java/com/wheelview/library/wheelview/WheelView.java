...
import com.wheelview.library.wheelview.adapter.AbstractWheelTextAdapter;
import com.wheelview.library.wheelview.adapter.ArrayWheelAdapter;
import com.wheelview.library.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	private static int[] SHADOWS_COLORS = new int[] { 0xe3ffffff,
			0xe3ffffff, 0x33ffffff };
